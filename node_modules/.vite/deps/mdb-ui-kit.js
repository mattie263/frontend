...
var Button$1 = class Button extends BaseComponent$1 {
  // Getters
  static get NAME() {
    return NAME$t;
  }
...
var EVENT_MOUSEENTER$2 = "mouseenter";
var EVENT_MOUSELEAVE$2 = "mouseleave";
...
var CLASS_NAME_SHOWN = "shown";
var CLASS_NAME_FIXED_ACTION_BTN = "fixed-action-btn";
var SELECTOR_ACTION_BUTTON = ".fixed-action-btn:not(.smooth-scroll) > .btn-floating";
var SELECTOR_LIST_ELEMENT = "ul .btn";
var SELECTOR_LIST$1 = "ul";
var Button2 = class _Button2 extends Button$1 {
  ...
  static jQueryInterface(config, options) {
    return this.each(function() {
      ...
      if (!data) {
        data = new _Button2(this, _config);
      }
...
var Offcanvas = class _Offcanvas extends BaseComponent$1 {
  constructor(element2, config) {
...
var Alert$1 = class Alert extends BaseComponent$1 {
  // Getters
  static get NAME() {
    return NAME$o;
  }
...
var NAME$n = "alert";
var EVENT_CLOSE_BS = "close.bs.alert";
var EVENT_CLOSED_BS = "closed.bs.alert";
var EXTENDED_EVENTS$6 = [{ name: "close" }, { name: "closed" }];
var Alert2 = class extends Alert$1 {
...
var Swipe = class _Swipe extends Config {
  constructor(element2, config) {
    super();
    this._element = element2;
    if (!element2 || !_Swipe.isSupported()) {
      return;
    }
    this._config = this._getConfig(config);
    this._deltaX = 0;
...
var Carousel$1 = class Carousel extends BaseComponent$1 {
  constructor(element2, config) {
    super(element2, config);
    this._interval = null;
...
var NAME$k = "carousel";
var EVENT_SLIDE_BS = "slide.bs.carousel";
var EVENT_SLID_BS = "slid.bs.carousel";
var EXTENDED_EVENTS$5 = [
  { name: "slide", parametersToCopy: ["relatedTarget", "direction", "from", "to"] },
  { name: "slid", parametersToCopy: ["relatedTarget", "direction", "from", "to"] }
];
var Carousel2 = class extends Carousel$1 {
  constructor(element2, data) {
    super(element2, data);
    this._init();
    Manipulator$1.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, true);
...
var Modal$1 = class Modal extends BaseComponent$1 {
  constructor(element2, config) {
    super(element2, config);
...
var NAME$i = "modal";
var EVENT_HIDE_BS$5 = "hide.bs.modal";
var EVENT_HIDE_PREVENTED_BS = "hidePrevented.bs.modal";
var EVENT_HIDDEN_BS$5 = "hidden.bs.modal";
var EVENT_SHOW_BS$5 = "show.bs.modal";
var EVENT_SHOWN_BS$5 = "shown.bs.modal";
var EXTENDED_EVENTS$4 = [
...
var Modal2 = class extends Modal$1 {
  constructor(element2, data) {
    super(element2, data);
    this._init();
    Manipulator$1.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, true);
...
var Popover$1 = class Popover extends Tooltip$1 {
  // Getters
  static get Default() {
    return Default$6;
  }
...
var NAME$e = "popover";
var EVENT_SHOW_BS$4 = "show.bs.popover";
var EVENT_SHOWN_BS$4 = "shown.bs.popover";
var EVENT_HIDE_BS$4 = "hide.bs.popover";
var EVENT_HIDDEN_BS$4 = "hidden.bs.popover";
var EVENT_INSERTED_BS$1 = "inserted.bs.popover";
var EXTENDED_EVENTS$3 = [
  { name: "show" },
  { name: "shown" },
  { name: "hide" },
  { name: "hidden" },
...
var Popover2 = class extends Popover$1 {
  constructor(element2, data) {
    super(element2, data);
    this._init();
    Manipulator$1.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, true);
...
var ScrollSpy$1 = class ScrollSpy extends BaseComponent$1 {
  constructor(element2, config) {
    super(element2, config);
...
var Tab$1 = class Tab extends BaseComponent$1 {
  constructor(element2) {
    super(element2);
...
var EVENT_SHOW_BS$3 = "show.bs.tab";
var EVENT_SHOWN_BS$3 = "shown.bs.tab";
var EVENT_HIDE_BS$3 = "hide.bs.tab";
var EVENT_HIDDEN_BS$3 = "hidden.bs.tab";
...
var NAME$9 = "tooltip";
var EVENT_HIDE_BS$2 = "hide.bs.tooltip";
var EVENT_HIDDEN_BS$2 = "hidden.bs.tooltip";
var EVENT_SHOW_BS$2 = "show.bs.tooltip";
var EVENT_SHOWN_BS$2 = "shown.bs.tooltip";
var EVENT_INSERTED_BS = "inserted.bs.tooltip";
var EXTENDED_EVENTS$2 = [
  { name: "show" },
  { name: "shown" },
  { name: "hide" },
  { name: "hidden" },
...
var Tooltip2 = class extends Tooltip$1 {
  constructor(element2, data) {
    super(element2, data);
    this._init();
    Manipulator$1.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, true);
...
var Toast$1 = class Toast extends BaseComponent$1 {
  constructor(element2, config) {
    super(element2, config);
    this._timeout = null;
...
var NAME$7 = "toast";
var EVENT_SHOW_BS$1 = "show.bs.toast";
var EVENT_SHOWN_BS$1 = "shown.bs.toast";
var EVENT_HIDE_BS$1 = "hide.bs.toast";
var EVENT_HIDDEN_BS$1 = "hidden.bs.toast";
var EXTENDED_EVENTS$1 = [{ name: "show" }, { name: "shown" }, { name: "hide" }, { name: "hidden" }];
var Toast2 = class extends Toast$1 {
  constructor(element2, data) {
    super(element2, data);
    this._init();
    Manipulator$1.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, true);
...
var NAME$6 = "input";
var DATA_KEY$5 = "mdb.input";
var CLASSNAME_ACTIVE$1 = "active";
var CLASSNAME_NOTCH = "form-notch";
var CLASSNAME_NOTCH_LEADING = "form-notch-leading";
var CLASSNAME_NOTCH_MIDDLE = "form-notch-middle";
var CLASSNAME_NOTCH_TRAILING = "form-notch-trailing";
var CLASSNAME_PLACEHOLDER_ACTIVE = "placeholder-active";
var CLASSNAME_HELPER = "form-helper";
var CLASSNAME_COUNTER = "form-counter";
...
var Input = class _Input extends BaseComponent2 {
  constructor(element2) {
    super(element2);
    this._label = null;
    this._labelWidth = 0;
...
var SELECTOR_DATA_TOGGLE$1 = "[data-mdb-collapse-init]";
var Default$3 = {
  parent: null,
  toggle: true
};
...
var Collapse$1 = class Collapse extends BaseComponent$1 {
  constructor(element2, config) {
    super(element2, config);
    this._isTransitioning = false;
    this._triggerArray = [];
...
var NAME$4 = "collapse";
var EVENT_SHOW_BS = "show.bs.collapse";
var EVENT_SHOWN_BS = "shown.bs.collapse";
var EVENT_HIDE_BS = "hide.bs.collapse";
var EVENT_HIDDEN_BS = "hidden.bs.collapse";
var EXTENDED_EVENTS = [{ name: "show" }, { name: "shown" }, { name: "hide" }, { name: "hidden" }];
var Collapse2 = class extends Collapse$1 {
  constructor(element2, data = {}) {
    super(element2, data);
    this._init();
    Manipulator$1.setDataAttribute(this._element, `${this.constructor.NAME}-initialized`, true);
...
var Ripple = class _Ripple extends BaseComponent2 {
  ...
  static jQueryInterface(options) {
    return this.each(function() {
      ...
      if (!data) {
        return new _Ripple(this, options);
      }
      return null;
    });
  }
